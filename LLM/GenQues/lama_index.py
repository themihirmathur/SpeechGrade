...
def load_data():
   with st.spinner(text="Loading and indexing the Documents `-` hang tight! This should take 1-2 minutes."):
       ...
       llm = Gemini(api_key="AIzaSyCbw_rkeY6Er5X3N1JiOSO6EP7dAprLZBM")
       llm = Gemini(api_key="AIzaSyCbw_rkeY6Er5X3N1JiOSO6EP7dAprLZBM")
       embed_model = GeminiEmbedding(api_key="AIzaSyCbw_rkeY6Er5X3N1JiOSO6EP7dAprLZBM")  # Fix typo
...
if "chat_engine" not in st.session_state.keys():
   ...
   llm = ChatGoogleGenerativeAI(model="gemini-pro", google_api_key="AIzaSyCbw_rkeY6Er5X3N1JiOSO6EP7dAprLZBM", temperature=0.1)
